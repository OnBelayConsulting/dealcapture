...
public enum DealColumnType {
	...
	UNDERLYING_INDEX_NAME ("UNDERLYING_INDEX", ColumnType.STRING),
	OPTION_EXPIRY_DATE_RULE ("OPTION_EXP_DATE_RULE", ColumnType.STRING),
	TRADE_TYPE ("TRADE_TYPE", ColumnType.STRING),
	OPTION_TYPE ("OPTION_TYPE", ColumnType.STRING),
	OPTION_STYLE ("OPTION_STYLE", ColumnType.STRING),
	STRIKE_PRICE ("STRIKE_PRICE", ColumnType.BIG_DECIMAL),
	STRIKE_PRICE_UOM ("STRIKE_PRICE_UOM", ColumnType.STRING),
	STRIKE_PRICE_CURRENCY ("STRIKE_PRICE_CURRENCY", ColumnType.STRING),
	PREMIUM_PRICE ("PREMIUM_PRICE", ColumnType.BIG_DECIMAL),
	PREMIUM_PRICE_UOM ("PREMIUM_PRICE_UOM", ColumnType.STRING),
	PREMIUM_PRICE_CURRENCY ("PREMIUM_PRICE_CURRENCY", ColumnType.STRING),
	;
