...
public class VanillaOptionPositionsFileWriterTest extends DealCaptureAppSpringTestCase {

    @Test
    public void writeVanillaOptionPositionsFile() {

        List<DealPositionView> views = new ArrayList<>();

        VanillaOptionPositionView view = new VanillaOptionPositionView();
        view.getViewDetail().setDealTypeCode(DealTypeCode.VANILLA_OPTION);
        ...
        view.getPriceDetail().setStrikePriceValue(BigDecimal.valueOf(3));
        view.getPriceDetail().setUnderlyingPriceValue(BigDecimal.valueOf(3));
        views.add(view);
        ...
        try (InputStreamReader reader = new InputStreamReader(inputStream)) {
            ...
            assertEquals("3.000", record.get(VanillaOptionPositionColumnType.STRIKE_PRICE.getCode()));
            assertEquals("3.000", record.get(VanillaOptionPositionColumnType.UNDERLYING_INDEX_PRICE.getCode()));
            parser.close();
        } catch (IOException e) {
