...
public class FinancialSwapPositionsFileWriterTest  extends DealCaptureAppSpringTestCase {

    @Test
    public void writeFixed4FloatFinancialSwapPositionsFile() {

        List<DealPositionView> views = new ArrayList<>();

        FinancialSwapPositionView view = new FinancialSwapPositionView();
        view.getViewDetail().setDealTypeCode(DealTypeCode.FINANCIAL_SWAP);
        ...
        view.getDetail().setPaysValuationCode(ValuationCode.FIXED);
        view.getDetail().setReceivesValuationCode(ValuationCode.INDEX);

        view.getPriceDetail().setPaysPriceValue(BigDecimal.valueOf(3));
        view.getPriceDetail().setTotalPaysPriceValue(BigDecimal.valueOf(3));
        view.getPriceDetail().setReceivesPriceValue(BigDecimal.valueOf(4));
        views.add(view);
