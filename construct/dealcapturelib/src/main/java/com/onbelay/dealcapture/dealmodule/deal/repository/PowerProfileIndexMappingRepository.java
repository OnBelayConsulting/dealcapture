...
public interface PowerProfileIndexMappingRepository {
	public static final String BEAN_NAME = "powerProfileIndexMappingRepository";

	public PowerProfileIndexMapping load(EntityId entityId);

	List<PowerProfileIndexMapping> findByPowerProfile(PowerProfile powerProfile);
}
