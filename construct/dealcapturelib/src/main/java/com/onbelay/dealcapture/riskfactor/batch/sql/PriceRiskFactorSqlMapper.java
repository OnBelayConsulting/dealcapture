...
public class PriceRiskFactorSqlMapper extends BaseSqlMapper {

	public PriceRiskFactorSqlMapper(boolean isAddPrimaryKey) {
		super(isAddPrimaryKey);
	}

	public String getTableName() {
		return "PRICE_RISK_FACTOR";
	}
	...
	public void setValuesOnPreparedStatement(
		...
		PriceRiskFactorSnapshot riskFactor = (PriceRiskFactorSnapshot) snapshot;
		int n;
		if (isAddPrimaryKey) {
			n= 1;
		...
		preparedStatement.setInt(n + 1, riskFactor.getPriceIndexId().getId());
