...
public interface InterestIndexRepository {
	public static final String BEAN_NAME = "interestIndexRepository";
	
	public InterestIndex findInterestIndexByName(String name);

	InterestIndex findInterestIndexByIsRiskFreeRate();

	public InterestIndex load(EntityId id);
