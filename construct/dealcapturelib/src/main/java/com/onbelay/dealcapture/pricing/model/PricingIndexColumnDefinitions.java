...
@Component(value = "pricingIndexColumnDefinitions")
public class PricingIndexColumnDefinitions extends BaseColumnDefinitions implements ColumnDefinitions{
	...
	public PricingIndexColumnDefinitions() {
		add(name);
		add(description);
		add(indexType);
	}
