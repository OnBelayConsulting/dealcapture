...
public class DealDayByMonthDetail {

    private LocalDate dealMonthDate;
    ...
    public void copyFrom(DealDayByMonthDetail copy) {
        ...
        if (copy.dealMonthDate != null)
            this.dealMonthDate = copy.dealMonthDate;
    ...
    public LocalDate getDealMonthDate() {
        return dealMonthDate;
    }

    public void setDealMonthDate(LocalDate date)  {
        this.dealMonthDate = date;
    }
