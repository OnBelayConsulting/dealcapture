...
public interface IndexPriceRepository {
	public static final String BEAN_NAME = "indexPriceRepository";
	
	public IndexPrice load(EntityId id);
	...
	public IndexPrice fetchCurrentPrice(EntityId entityId, LocalDate currentDate);
