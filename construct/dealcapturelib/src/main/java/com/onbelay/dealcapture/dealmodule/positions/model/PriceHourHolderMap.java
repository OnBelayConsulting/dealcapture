...
public class PriceHourHolderMap {
    ...
    private void initializeSetterMap() {
        hourSetterMap.put(1, (PriceRiskFactorHolder c) -> setHour1PriceHolder(c));
        hourSetterMap.put(2, (PriceRiskFactorHolder c) -> setHour2PriceHolder(c));
        hourSetterMap.put(3, (PriceRiskFactorHolder c) -> setHour3PriceHolder(c));
        hourSetterMap.put(4, (PriceRiskFactorHolder c) -> setHour4PriceHolder(c));
        hourSetterMap.put(5, (PriceRiskFactorHolder c) -> setHour5PriceHolder(c));
        hourSetterMap.put(6, (PriceRiskFactorHolder c) -> setHour6PriceHolder(c));
        hourSetterMap.put(7, (PriceRiskFactorHolder c) -> setHour7PriceHolder(c));
        hourSetterMap.put(8, (PriceRiskFactorHolder c) -> setHour8PriceHolder(c));
        hourSetterMap.put(9, (PriceRiskFactorHolder c) -> setHour9PriceHolder(c));
        hourSetterMap.put(10, (PriceRiskFactorHolder c) -> setHour10PriceHolder(c));
        hourSetterMap.put(11, (PriceRiskFactorHolder c) -> setHour11PriceHolder(c));
        hourSetterMap.put(12, (PriceRiskFactorHolder c) -> setHour12PriceHolder(c));
        hourSetterMap.put(13, (PriceRiskFactorHolder c) -> setHour13PriceHolder(c));
        hourSetterMap.put(14, (PriceRiskFactorHolder c) -> setHour14PriceHolder(c));
        hourSetterMap.put(15, (PriceRiskFactorHolder c) -> setHour15PriceHolder(c));
        hourSetterMap.put(16, (PriceRiskFactorHolder c) -> setHour16PriceHolder(c));
        hourSetterMap.put(17, (PriceRiskFactorHolder c) -> setHour17PriceHolder(c));
        hourSetterMap.put(18, (PriceRiskFactorHolder c) -> setHour18PriceHolder(c));
        hourSetterMap.put(19, (PriceRiskFactorHolder c) -> setHour19PriceHolder(c));
        hourSetterMap.put(20, (PriceRiskFactorHolder c) -> setHour20PriceHolder(c));
        hourSetterMap.put(21, (PriceRiskFactorHolder c) -> setHour21PriceHolder(c));
        hourSetterMap.put(22, (PriceRiskFactorHolder c) -> setHour22PriceHolder(c));
        hourSetterMap.put(23, (PriceRiskFactorHolder c) -> setHour23PriceHolder(c));
        hourSetterMap.put(24, (PriceRiskFactorHolder c) -> setHour24PriceHolder(c));
    }

    private void initializeGetterMap() {
        hourGetterMap.put(1, () -> getHour1PriceHolder());
        hourGetterMap.put(2, () -> getHour2PriceHolder());
        hourGetterMap.put(3, () -> getHour3PriceHolder());
        hourGetterMap.put(4, () -> getHour4PriceHolder());
        hourGetterMap.put(5, () -> getHour5PriceHolder());
        hourGetterMap.put(6, () -> getHour6PriceHolder());
        hourGetterMap.put(7, () -> getHour7PriceHolder());
        hourGetterMap.put(8, () -> getHour8PriceHolder());
        hourGetterMap.put(9, () -> getHour9PriceHolder());
        hourGetterMap.put(10, () -> getHour10PriceHolder());
        hourGetterMap.put(11, () -> getHour11PriceHolder());
        hourGetterMap.put(12, () -> getHour12PriceHolder());
        hourGetterMap.put(13, () -> getHour13PriceHolder());
        hourGetterMap.put(14, () -> getHour14PriceHolder());
        hourGetterMap.put(15, () -> getHour15PriceHolder());
        hourGetterMap.put(16, () -> getHour16PriceHolder());
        hourGetterMap.put(17, () -> getHour17PriceHolder());
        hourGetterMap.put(18, () -> getHour18PriceHolder());
        hourGetterMap.put(19, () -> getHour19PriceHolder());
        hourGetterMap.put(20, () -> getHour20PriceHolder());
        hourGetterMap.put(21, () -> getHour21PriceHolder());
        hourGetterMap.put(22, () -> getHour22PriceHolder());
        hourGetterMap.put(23, () -> getHour23PriceHolder());
        hourGetterMap.put(24, () -> getHour24PriceHolder());
    }
}
