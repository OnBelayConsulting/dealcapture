...
@Component(value = "dealHourlyPositionColumnDefinitions")
public class DealHourlyPositionColumnDefinitions extends BaseColumnDefinitions implements ColumnDefinitions{
	...
	public DealHourlyPositionColumnDefinitions() {
		add(dealId);
		add(startDate);
		add(endDate);
	}
