...
public interface FxIndexRepository {
	public static final String BEAN_NAME = "fxIndexRepository";
	
	public FxIndex findFxIndexByName(String name);

	public List<FxIndex> findFxIndexByFromToCurrencyCodes(CurrencyCode from, CurrencyCode to);
