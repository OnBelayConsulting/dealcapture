...
public interface PricingIndexService {
	
	public PricingIndexSnapshot load(EntityId entityId);

	public TransactionResult save(PricingIndexSnapshot snapshotIn);
	...
	List<IndexPriceSnapshot> fetchPricesByIds(QuerySelectedPage querySelectedPage);
}
