...
public class GeneratePositionsServiceWithCostsTest extends PhysicalDealServiceTestCase {
    ...
    public void generateWithMultipleCosts() {
        ...
        assertEquals(positionSnapshot.getPositionDetail().getCreatedDateTime(), facilityPerUnitFee.getDetail().getCreatedDateTime());
